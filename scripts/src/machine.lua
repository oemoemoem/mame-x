...
if (MACHINES["PCI"]~=null) then
	files {
		...
		MAME_DIR .. "src/devices/machine/i82830m.cpp",
		MAME_DIR .. "src/devices/machine/i82830m.h",
		MAME_DIR .. "src/devices/machine/i82801db.cpp",
		MAME_DIR .. "src/devices/machine/i82801db.h",
...
---------------------------------------------------
--
--@src/devices/machine/lpc47m192.h,MACHINES["LPC47M192"] = true
---------------------------------------------------

if (MACHINES["LPC47M192"]~=null) then
	files {
		MAME_DIR .. "src/devices/machine/lpc47m192.cpp",
		MAME_DIR .. "src/devices/machine/lpc47m192.h",
	}
end
