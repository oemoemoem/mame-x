...
--------------------------------------------------
--
--@src/devices/video/nvidia_curie.h,VIDEOS["NVIDIA_CURIE"] = true
--------------------------------------------------

if (VIDEOS["NVIDIA_CURIE"]~=null) then
	files {
		MAME_DIR .. "src/devices/video/nvidia_curie.cpp",
		MAME_DIR .. "src/devices/video/nvidia_curie.h",
	}
end
