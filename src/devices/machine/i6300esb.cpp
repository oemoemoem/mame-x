...
DEFINE_DEVICE_TYPE(I6300ESB_IDE, 	  i6300esb_ide_device, 		"i6300esb_ide", 	 "Intel i6300ESB southbridge IDE interface")
...
void i6300esb_lpc_device::cpu_a20_w(int state)
{
...
void i6300esb_lpc_device::cpu_reset_w(int state)
{
	// TODO: masked via INIT $46 bit 0
	m_maincpu->set_input_line(INPUT_LINE_RESET, state);
}

void i6300esb_lpc_device::device_add_mconfig(machine_config &config)
{
	// Confirmed 82C59s
	...
	m_keybc->hot_res().set(FUNC(i6300esb_lpc_device::cpu_reset_w));
	m_keybc->gate_a20().set(FUNC(i6300esb_lpc_device::cpu_a20_w));
...
#if 0
void i6300esb_lpc_device::iochck_w(int state)
{
...
uint32_t i6300esb_lpc_device::pmbase_r()
{
	return pmbase | 1;
}

void i6300esb_lpc_device::pmbase_w(offs_t offset, uint32_t data, uint32_t mem_mask)
{
	COMBINE_DATA(&pmbase);
	pmbase &= 0x0000ff80;
...
void i6300esb_lpc_device::acpi_cntl_w(uint8_t data)
{
	acpi_cntl = data;
...
void i6300esb_lpc_device::bios_cntl_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void i6300esb_lpc_device::tco_cntl_w(uint8_t data)
{
	tco_cntl = data;
	logerror("%s: tco_cntl = %02x\n", tag(), tco_cntl);
}

uint32_t i6300esb_lpc_device::gpio_base_r()
{
	return gpio_base | 1;
}

void i6300esb_lpc_device::gpio_base_w(offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
void i6300esb_lpc_device::gpio_cntl_w(uint8_t data)
{
	gpio_cntl = data;
...
void i6300esb_lpc_device::pirq_rout_w(offs_t offset, uint8_t data)
{
	pirq_rout[offset] = data;
	logerror("%s: pirq_rout[%d] = %02x\n", tag(), offset, pirq_rout[offset]);
}

uint8_t i6300esb_lpc_device::serirq_cntl_r()
{
	return serirq_cntl;
}

void i6300esb_lpc_device::serirq_cntl_w(uint8_t data)
{
	serirq_cntl = data;
	logerror("%s: serirq_cntl = %02x\n", tag(), serirq_cntl);
}

uint8_t i6300esb_lpc_device::pirq2_rout_r(offs_t offset)
{
	return pirq_rout_r(offset+4);
}

void i6300esb_lpc_device::pirq2_rout_w(offs_t offset, uint8_t data)
{
	pirq_rout_w(offset+4, data);
}

uint8_t i6300esb_lpc_device::d31_err_cfg_r()
{
	return d31_err_cfg;
}

void i6300esb_lpc_device::d31_err_cfg_w(uint8_t data)
{
	d31_err_cfg = data;
	logerror("%s: d31_err_cfg = %02x\n", tag(), d31_err_cfg);
}

uint8_t i6300esb_lpc_device::d31_err_sts_r()
{
	return d31_err_sts;
}

void i6300esb_lpc_device::d31_err_sts_w(uint8_t data)
{
	d31_err_sts &= ~data;
	logerror("%s: d31_err_sts = %02x\n", tag(), d31_err_sts);
}

uint16_t i6300esb_lpc_device::pci_dma_cfg_r()
{
	return pci_dma_cfg;
}

void i6300esb_lpc_device::pci_dma_cfg_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&pci_dma_cfg);
	logerror("%s: pci_dma_cfg = %04x\n", tag(), pci_dma_cfg);
}

uint16_t i6300esb_lpc_device::gen_pmcon_1_r()
{
	return gen_pmcon_1;
}

void i6300esb_lpc_device::gen_pmcon_1_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&gen_pmcon_1);
	logerror("%s: gen_pmcon_1 = %04x\n", tag(), gen_pmcon_1);
}

uint8_t i6300esb_lpc_device::gen_pmcon_2_r()
{
	return gen_pmcon_2;
}

void i6300esb_lpc_device::gen_pmcon_2_w(uint8_t data)
{
	gen_pmcon_2 = data;
	logerror("%s: gen_pmcon_2 = %02x\n", tag(), gen_pmcon_2);
}

uint8_t i6300esb_lpc_device::gen_pmcon_3_r()
{
	return gen_pmcon_3;
}

void i6300esb_lpc_device::gen_pmcon_3_w(uint8_t data)
{
	gen_pmcon_3 = data;
	logerror("%s: gen_pmcon_3 = %02x\n", tag(), gen_pmcon_3);
}

uint32_t i6300esb_lpc_device::rst_cnt2_r()
{
	return rst_cnt2;
}

void i6300esb_lpc_device::rst_cnt2_w(offs_t offset, uint32_t data, uint32_t mem_mask)
{
	COMBINE_DATA(&rst_cnt2);
	logerror("%s: rst_cnt2 = %08x\n", tag(), rst_cnt2);
}

uint8_t i6300esb_lpc_device::apm_cnt_r()
{
	return apm_cnt;
}

void i6300esb_lpc_device::apm_cnt_w(uint8_t data)
{
	apm_cnt = data;
	logerror("%s: apm_cnt = %02x\n", tag(), apm_cnt);
}

uint8_t i6300esb_lpc_device::apm_sts_r()
{
	return apm_sts;
}

void i6300esb_lpc_device::apm_sts_w(uint8_t data)
{
	apm_sts = data;
	logerror("%s: apm_sts = %02x\n", tag(), apm_sts);
}

uint32_t i6300esb_lpc_device::gpi_rout_r()
{
	return gpi_rout;
}

void i6300esb_lpc_device::gpi_rout_w(offs_t offset, uint32_t data, uint32_t mem_mask)
{
	COMBINE_DATA(&gpi_rout);
	logerror("%s: gpi_rout = %08x\n", tag(), gpi_rout);
}

uint8_t i6300esb_lpc_device::mon_fwd_en_r()
{
	return mon_fwd_en;
}

void i6300esb_lpc_device::mon_fwd_en_w(uint8_t data)
{
	mon_fwd_en = data;
	logerror("%s: mon_fwd_en = %02x\n", tag(), mon_fwd_en);
}

uint16_t i6300esb_lpc_device::mon_trp_rng_r(offs_t offset)
{
	return mon_trp_rng[offset];
}

void i6300esb_lpc_device::mon_trp_rng_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&mon_trp_rng[offset]);
	logerror("%s: mon_trp_rng[%d] = %04x\n", tag(), 4+offset, mon_trp_rng[offset]);
}

uint16_t i6300esb_lpc_device::mon_trp_msk_r()
{
	return mon_trp_msk;
}

void i6300esb_lpc_device::mon_trp_msk_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&mon_trp_msk);
	logerror("%s: mon_trp_msk = %04x\n", tag(), mon_trp_msk);
}

uint32_t i6300esb_lpc_device::gen_cntl_r()
{
	return gen_cntl;
}

void i6300esb_lpc_device::gen_cntl_w(offs_t offset, uint32_t data, uint32_t mem_mask)
{
	COMBINE_DATA(&gen_cntl);
	logerror("%s: gen_cntl = %08x\n", tag(), gen_cntl);
}

uint8_t i6300esb_lpc_device::gen_sta_r()
{
	return gen_sta;
}

void i6300esb_lpc_device::gen_sta_w(uint8_t data)
{
	gen_sta = data;
	logerror("%s: gen_sta = %02x\n", tag(), gen_sta);
}

uint8_t i6300esb_lpc_device::back_cntl_r()
{
	return back_cntl;
}

void i6300esb_lpc_device::back_cntl_w(uint8_t data)
{
	back_cntl = data;
...
void i6300esb_lpc_device::rtc_conf_w(uint8_t data)
{
	rtc_conf = data;
...
void i6300esb_lpc_device::lpc_if_com_range_w(uint8_t data)
{
...
void i6300esb_lpc_device::lpc_if_fdd_lpt_range_w(offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void i6300esb_lpc_device::lpc_if_sound_range_w(offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void i6300esb_lpc_device::fwh_dec_en1_w(uint8_t data)
{
...
void i6300esb_lpc_device::gen1_dec_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void i6300esb_lpc_device::lpc_en_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&lpc_en);
...
void i6300esb_lpc_device::fwh_sel1_w(offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
void i6300esb_lpc_device::gen2_dec_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void i6300esb_lpc_device::fwh_sel2_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void i6300esb_lpc_device::fwh_dec_en2_w(uint8_t data)
{
	fwh_dec_en2 = data;
...
void i6300esb_lpc_device::func_dis_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&func_dis);
	logerror("%s: func_dis = %04x\n", tag(), func_dis);
}

uint32_t i6300esb_lpc_device::etr1_r()
{
	return etr1;
}

void i6300esb_lpc_device::etr1_w(offs_t offset, uint32_t data, uint32_t mem_mask)
{
	COMBINE_DATA(&etr1);
	logerror("%s: etr1 = %08x\n", tag(), etr1);
}

uint32_t i6300esb_lpc_device::mfid_r()
{
	return 0xf66;
}

uint32_t i6300esb_lpc_device::unk_fc_r()
{
	logerror("%s: read undocumented config reg fc\n", tag());
	return 0;
}

void i6300esb_lpc_device::unk_fc_w(uint32_t data)
{
...
uint8_t i6300esb_lpc_device::siu_config_port_r()
{
	return siu_config_port;
}

void i6300esb_lpc_device::siu_config_port_w(uint8_t data)
{
...
uint8_t i6300esb_lpc_device::siu_data_port_r()
{
	logerror("%s: siu config read port %02x\n", tag(), siu_config_port);
	return 0xff;
}

void i6300esb_lpc_device::siu_data_port_w(uint8_t data)
{
	if(siu_config_state < 2) {
...
uint8_t i6300esb_lpc_device::nmi_sc_r()
{
	nmi_sc ^= 0x10;
	return nmi_sc;
}

void i6300esb_lpc_device::nmi_sc_w(uint8_t data)
{
	nmi_sc = data;
...
void i6300esb_lpc_device::nop_w(uint8_t data)
{
}
...
void i6300esb_ide_device::config_map(address_map &map)
{
	pci_device::config_map(map);
	map(0x06, 0x07).rw(FUNC(i6300esb_ide_device::status_r), FUNC(i6300esb_ide_device::status_w));
	map(0x0d, 0x0d).rw(FUNC(i6300esb_ide_device::latency_timer_r), FUNC(i6300esb_ide_device::latency_timer_w));
	map(0x10, 0x1f).noprw();
	map(0x20, 0x23).rw(FUNC(i6300esb_ide_device::bmiba_r), FUNC(i6300esb_ide_device::bmiba_w));
	map(0x24, 0x3b).noprw();
	map(0x40, 0x41).rw(FUNC(i6300esb_ide_device::idetim_primary_r), FUNC(i6300esb_ide_device::idetim_primary_w));
	map(0x42, 0x43).rw(FUNC(i6300esb_ide_device::idetim_secondary_r), FUNC(i6300esb_ide_device::idetim_secondary_w));
	map(0x44, 0x44).rw(FUNC(i6300esb_ide_device::sidetim_r), FUNC(i6300esb_ide_device::sidetim_w));
}

void i6300esb_ide_device::internal_io_map(address_map &map)
{
	map(0x0170, 0x0177).rw(FUNC(i6300esb_ide_device::ide2_read32_cs0_r), FUNC(i6300esb_ide_device::ide2_write32_cs0_w));
	map(0x01f0, 0x01f7).rw(FUNC(i6300esb_ide_device::ide1_read32_cs0_r), FUNC(i6300esb_ide_device::ide1_write32_cs0_w));
	map(0x0376, 0x0376).rw(FUNC(i6300esb_ide_device::ide2_read_cs1_r), FUNC(i6300esb_ide_device::ide2_write_cs1_w));
	map(0x03f6, 0x03f6).rw(FUNC(i6300esb_ide_device::ide1_read_cs1_r), FUNC(i6300esb_ide_device::ide1_write_cs1_w));
}

void i6300esb_ide_device::device_add_mconfig(machine_config &config)
{
	BUS_MASTER_IDE_CONTROLLER(config, m_ide1).options(ata_devices, "hdd", nullptr, false);
	m_ide1->irq_handler().set(FUNC(i6300esb_ide_device::primary_int));

	BUS_MASTER_IDE_CONTROLLER(config, m_ide2).options(ata_devices, "cdrom", nullptr, false);
	m_ide2->irq_handler().set(FUNC(i6300esb_ide_device::secondary_int));
}

void i6300esb_ide_device::device_config_complete()
{
...
i6300esb_ide_device::i6300esb_ide_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, uint32_t clock)
...
i6300esb_ide_device::i6300esb_ide_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock)
	: i6300esb_ide_device(mconfig, I6300ESB_IDE, tag, owner, clock)
{
	set_ids(0x808625a2, 0x02, 0x010180, 0x00000000);
}

void i6300esb_ide_device::device_start()
{
	pci_device::device_start();
	status = 0x0280;
	command = 0;
...
void i6300esb_ide_device::device_reset()
{
}

void i6300esb_ide_device::reset_all_mappings()
{
}

void i6300esb_ide_device::map_extra(
...
{
	io_space->install_device(0, 0x3ff, *this, &i6300esb_ide_device::internal_io_map);
	if (command & 1)
	{
...
void i6300esb_ide_device::primary_int(int state)
{
	m_irq_pri_callback(state);
}

void i6300esb_ide_device::secondary_int(int state)
{
	m_irq_sec_callback(state);
}

void i6300esb_ide_device::status_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint8_t i6300esb_ide_device::latency_timer_r()
{
	return latency_timer;
}

void i6300esb_ide_device::latency_timer_w(uint8_t data)
{
	latency_timer = data;
	logerror("latency_timer = %02x\n", latency_timer);
}

uint32_t i6300esb_ide_device::bmiba_r()
{
	return bmiba;
}

void i6300esb_ide_device::bmiba_w(offs_t offset, uint32_t data, uint32_t mem_mask)
{
	mem_mask &= 0xfff0;
	COMBINE_DATA(&bmiba);
	logerror("bmiba = %04x\n", bmiba);
...
uint16_t i6300esb_ide_device::idetim_primary_r()
{
	return idetim_primary;
}

void i6300esb_ide_device::idetim_primary_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&idetim_primary);
	logerror("idetim_primary = %04x\n", idetim_primary);
}

uint16_t i6300esb_ide_device::idetim_secondary_r()
{
	return idetim_secondary;
}

void i6300esb_ide_device::idetim_secondary_w(offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&idetim_secondary);
	logerror("idetim_secondary = %04x\n", idetim_secondary);
}

uint8_t i6300esb_ide_device::sidetim_r()
{
	return sidetim;
}

void i6300esb_ide_device::sidetim_w(uint8_t data)
{
	sidetim = data;
	logerror("sidetim = %02x\n", sidetim);
}

uint32_t i6300esb_ide_device::ide1_read32_cs0_r(offs_t offset, uint32_t mem_mask)
{
	if (!(command & 1))
		return 0xffffffff;
...
void i6300esb_ide_device::ide1_write32_cs0_w(offs_t offset, uint32_t data, uint32_t mem_mask)
{
	if (!(command & 1))
		return;
...
uint32_t i6300esb_ide_device::ide2_read32_cs0_r(offs_t offset, uint32_t mem_mask)
{
	if (!(command & 1))
		return 0xffffffff;
...
void i6300esb_ide_device::ide2_write32_cs0_w(offs_t offset, uint32_t data, uint32_t mem_mask)
{
	if (!(command & 1))
		return;
...
uint8_t i6300esb_ide_device::ide1_read_cs1_r()
{
	if (!(command & 1))
		return 0xff;
...
void i6300esb_ide_device::ide1_write_cs1_w(uint8_t data)
{
	if (!(command & 1))
		return;
...
uint8_t i6300esb_ide_device::ide2_read_cs1_r()
{
	if (!(command & 1))
		return 0xff;
...
void i6300esb_ide_device::ide2_write_cs1_w(uint8_t data)
{
	if (!(command & 1))
		return;
