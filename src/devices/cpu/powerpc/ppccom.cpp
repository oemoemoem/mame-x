...
DEFINE_DEVICE_TYPE(PPC750CXE, ppc750cxe_device, "ppc750cxe",  "IBM PowerPC 750CXe")
...
ppc750cxe_device::ppc750cxe_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock)
	: ppc_device(mconfig, PPC750CXE, tag, owner, clock, 32, 64, PPC_MODEL_750CX, PPCCAP_OEA | PPCCAP_VEA | PPCCAP_FPU | PPCCAP_MISALIGNED | PPCCAP_604_MMU | PPCCAP_750_TLB, 4, address_map_constructor())
{
}
