...
class isa16_bxas1928_mb : public device_t, public device_isa16_card_interface
{
public:
  // construction/destruction
  isa16_bxas1928_mb(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
...
DEFINE_DEVICE_TYPE(ISA16_BXAS1928_MB, isa16_bxas1928_mb, "isa16_bxas1928_mb", "ISA16 BXAS1-928 Virtual MB resources")

isa16_bxas1928_mb::isa16_bxas1928_mb(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock)
  : device_t(mconfig, ISA16_BXAS1928_MB, tag, owner, clock)
...
void isa16_bxas1928_mb::device_add_mconfig(machine_config &config)
{
...
void isa16_bxas1928_mb::device_start()
{
  set_isa_device();
}

void isa16_bxas1928_mb::device_reset()
{

}

void isa16_bxas1928_mb::remap(int space_id, offs_t start, offs_t end)
{
  if (space_id == AS_IO)
  {
...
//device.option_add("fdc37c93x", FDC37C93X);
  device.option_add_internal("bxas1928_mb", ISA16_BXAS1928_MB);
}
...
void comebaby_state::comebaby(machine_config &config)
{
	...
	I82443BX_HOST(config, "pci:00.0", 0, "maincpu", 768*1024*1024);
  ...
  ISA16_SLOT(config, "board2", 0, "pci:07.0:isabus", isa_internal_devices, "bxas1928_mb", true);
...
COMP( 2000, bxas1928, 0, 0, comebaby, comebaby, comebaby_state, empty_init, "PC Partner", "BXAS1-928", 0)
