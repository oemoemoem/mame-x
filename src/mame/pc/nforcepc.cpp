...
void nforcepc_state::machine_start()
{
	...
	nvidia_nv40 = subdevice<geforce_7600gs_device>("pci:1e.0:00.0")->debug_get_renderer();
}
...
void nforcepc_state::nforcepc(machine_config &config)
{
  ...
  m_vga->set_vram_size(256*1024*1024);
	...
	GEFORCE_7600GS(config, "pci:1e.0:00.0", 0, 0x10de02e1, m_vga, "maincpu");
...
ROM_START(nforcepc)
	...
	ROM_REGION32_LE(0x10000, "pci:1e.0:00.0", 0) /* Geforce bios extension (custom for the card) */
...
COMP(2002, nforcepc, 0, 0, nforcepc, nforcepc, nforcepc_state, empty_init, "Nvidia", "Nvidia nForce PC (CRUSH11/12)", 0)
